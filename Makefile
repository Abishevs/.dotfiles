...
DOTFILES_DIR := $(GIT_ROOT)/packages	
STOW_TARGET := $(HOME)
...
help:
	...
	@echo "  stow 	[PKG=]  Stow all (optionaly provide package/ module) directories from the root of the repo"
	@echo "  unstow [PKG=]  Unstow all directories from the root of the repo"
